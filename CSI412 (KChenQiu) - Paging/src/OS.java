...
public class OS {
	...
	public static void GetMapping(int virtualPageNumber) {
		...
		if(randInt == 0) {
			pcb.getUserlandProcess().setTLB(0, virtualPageNumber, pcb.getPage(virtualPageNumber-1));
		}
		else if(randInt == 1) {
			pcb.getUserlandProcess().setTLB(1, virtualPageNumber, pcb.getPage(virtualPageNumber-1));
		}
	}
